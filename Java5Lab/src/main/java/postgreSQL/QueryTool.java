...
public class QueryTool {
	...
	/*
	 public static void alterSequences() throws SQLException {
		Execute(String.format(alter_sequence, animal));
		Execute(String.format(alter_sequence, cat));
		Execute(String.format(alter_sequence, tiger));
	}
	*/
}
